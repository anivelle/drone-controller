...
void icm20948_isr(const void *args) {
...
int main(void) {
    ...
    k_sem_take(&icm20948_ready, K_NO_WAIT);
    ...
    // Create a thread that constantly tries to read from the IMU
    ...
    icm20948_setregister(i2c_dev, ICM20948_INT_PIN_CFG, INT1_LATCH_EN);   
