...
int begin(VL53L4CX_Dev_t *pdev) {
    if (pdev->xshut >= 0) {
        gpio_pin_configure(pdev->port, pdev->xshut, GPIO_OUTPUT);
...
VL53L4CX_Error VL53L4CX_run_ref_spad_char(
  VL53L4CX_Dev_t *        Dev,
...
VL53L4CX_Error VL53L4CX_init_zone_config_histogram_bins(
...
VL53L4CX_Error VL53L4CX_set_zone_config(
  VL53L4CX_DEV                 Dev,
...
VL53L4CX_Error VL53L4CX_get_zone_config(
  VL53L4CX_DEV                 Dev,
  VL53L4CX_zone_config_t      *pzone_cfg)
{
...
VL53L4CX_Error VL53L4CX_GetProductRevision(VL53L4CX_Dev_t *Dev, uint8_t *pProductRevisionMajor, uint8_t *pProductRevisionMinor)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  uint8_t revision_id;
...
VL53L4CX_Error VL53L4CX_GetDeviceInfo(VL53L4CX_Dev_t *Dev, VL53L4CX_DeviceInfo_t *pVL53L4CX_DeviceInfo)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  uint8_t revision_id;
  VL53L4CX_LLDriverData_t   *pLLData;
...
VL53L4CX_Error VL53L4CX_SetDeviceAddress(VL53L4CX_Dev_t *Dev, uint8_t DeviceAddress)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  VL53L4CX_LLDriverData_t *pdev = VL53L4CXDevStructGetLLDriverHandle(Dev);
...
VL53L4CX_Error VL53L4CX_DataInit(VL53L4CX_Dev_t *Dev)
{
  ...
  if (Status == VL53L4CX_ERROR_NONE) {
    Status = VL53L4CX_SetMeasurementTimingBudgetMicroSeconds(Dev, 33333);
  }
  ...
  if (Status == VL53L4CX_ERROR_NONE) {
    Status = VL53L4CX_SmudgeCorrectionEnable(Dev, VL53L4CX_SMUDGE_CORRECTION_NONE);
  }
...
VL53L4CX_Error VL53L4CX_SetDistanceMode(VL53L4CX_Dev_t *Dev, VL53L4CX_DistanceModes DistanceMode)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  uint32_t inter_measurement_period_ms;
...
VL53L4CX_Error VL53L4CX_GetDistanceMode(VL53L4CX_Dev_t *Dev, VL53L4CX_DistanceModes *pDistanceMode)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_SetMeasurementTimingBudgetMicroSeconds(VL53L4CX_Dev_t *Dev, uint32_t MeasurementTimingBudgetMicroSeconds)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_GetMeasurementTimingBudgetMicroSeconds(VL53L4CX_Dev_t *Dev, uint32_t *pMeasurementTimingBudgetMicroSeconds)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  uint32_t MmTimeoutUs = 0;
...
VL53L4CX_Error VL53L4CX_SetUserROI(VL53L4CX_Dev_t *Dev, VL53L4CX_UserRoi_t *pRoi)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_GetUserROI(VL53L4CX_Dev_t *Dev, VL53L4CX_UserRoi_t *pRoi)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  VL53L4CX_zone_config_t zone_cfg;
  uint8_t  TopLeftX;
...
VL53L4CX_Error VL53L4CX_GetMultiRangingData(VL53L4CX_Dev_t *Dev, VL53L4CX_MultiRangingData_t *pMultiRangingData)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  VL53L4CX_LLDriverData_t *pdev =
    VL53L4CXDevStructGetLLDriverHandle(Dev);
...
VL53L4CX_Error VL53L4CX_GetAdditionalData(VL53L4CX_Dev_t *Dev, VL53L4CX_AdditionalData_t *pAdditionalData)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_SetTuningParameter(VL53L4CX_Dev_t *Dev, uint16_t TuningParameterId, int32_t TuningParameterValue)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_GetTuningParameter(VL53L4CX_Dev_t *Dev, uint16_t TuningParameterId, int32_t *pTuningParameterValue)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_PerformRefSpadManagement(VL53L4CX_Dev_t *Dev)
{
  ...
  if (Status == VL53L4CX_ERROR_NONE) {
    ...
    if (Status == VL53L4CX_ERROR_NONE) {
      Status = VL53L4CX_SetDistanceMode(Dev, DistanceMode);
    }
  }
...
VL53L4CX_Error VL53L4CX_SmudgeCorrectionEnable(VL53L4CX_Dev_t *Dev, VL53L4CX_SmudgeCorrectionModes Mode)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_SetXTalkCompensationEnable(VL53L4CX_Dev_t *Dev, uint8_t XTalkCompensationEnable)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_GetXTalkCompensationEnable(VL53L4CX_Dev_t *Dev, uint8_t *pXTalkCompensationEnable)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_PerformXTalkCalibration(VL53L4CX_Dev_t *Dev)
{
  ...
  VL53L4CX_GetCalibrationData(Dev, &caldata);
  ...
  if ((UStatus ==
    ...
    *pLLDataPlaneOffsetKcps = DefaultOffset;
    ...
    VL53L4CX_SetCalibrationData(Dev, &caldata);
  }
...
VL53L4CX_Error VL53L4CX_SetOffsetCorrectionMode(VL53L4CX_Dev_t *Dev, VL53L4CX_OffsetCorrectionModes OffsetCorrectionMode)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  VL53L4CX_OffsetCorrectionMode offset_cor_mode;
...
VL53L4CX_Error VL53L4CX_PerformOffsetSimpleCalibration(VL53L4CX_Dev_t *Dev, int32_t CalDistanceMilliMeter)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  int32_t sum_ranging;
  uint8_t offset_meas;
  ...
  while ((Repeat > 0) && (Status == VL53L4CX_ERROR_NONE)) {
    Status = VL53L4CX_StartMeasurement(Dev);

    if (Status == VL53L4CX_ERROR_NONE) {
      VL53L4CX_WaitMeasurementDataReady(Dev);
      VL53L4CX_GetMultiRangingData(Dev, &RangingMeasurementData);
      VL53L4CX_ClearInterruptAndStartMeasurement(Dev);
    }
    ...
    while ((Status == VL53L4CX_ERROR_NONE) && (inloopcount < Max) &&
           (offset_meas < OverMax)) {
      Status = VL53L4CX_WaitMeasurementDataReady(Dev);
      if (Status == VL53L4CX_ERROR_NONE) {
        Status = VL53L4CX_GetMultiRangingData(Dev, &RangingMeasurementData);
      }
      ...
      Status = VL53L4CX_ClearInterruptAndStartMeasurement(Dev);
      offset_meas++;
    }
...
VL53L4CX_Error VL53L4CX_SetCalibrationData(VL53L4CX_Dev_t *Dev, VL53L4CX_CalibrationData_t *pCalibrationData)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
...
VL53L4CX_Error VL53L4CX_GetCalibrationData(VL53L4CX_Dev_t *Dev, VL53L4CX_CalibrationData_t  *pCalibrationData)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  VL53L4CX_calibration_data_t      cal_data;
  VL53L4CX_CustomerNvmManaged_t         *pC;
...
VL53L4CX_Error VL53L4CX_PerformOffsetPerVcselCalibration(VL53L4CX_Dev_t *Dev, int32_t CalDistanceMilliMeter)
{
  VL53L4CX_Error Status = VL53L4CX_ERROR_NONE;
  ...
  Status = VL53L4CX_GetDistanceMode(Dev, &currentDist);

  while ((Repeat < 3) && (Status == VL53L4CX_ERROR_NONE)) {
    Status = VL53L4CX_SetDistanceMode(Dev, DistMode[Repeat]);
    Status = VL53L4CX_StartMeasurement(Dev);
  ...
  VL53L4CX_SetDistanceMode(Dev, currentDist);
...
VL53L4CX_Error VL53L4CX_WriteMulti(VL53L4CX_DEV Dev, uint16_t index, uint8_t *pdata, uint32_t count)
{
  ...
  status = VL53L4CX_I2CWrite(Dev, index, pdata, (uint16_t)count);
  return status;
}
...
VL53L4CX_Error VL53L4CX_ReadMulti(VL53L4CX_DEV Dev, uint16_t index, uint8_t *pdata, uint32_t count)
{
  ...
  status = VL53L4CX_I2CRead(Dev, index, pdata, (uint16_t)count);
...
VL53L4CX_Error VL53L4CX_WrByte(VL53L4CX_DEV Dev, uint16_t index, uint8_t data)
{
  ...
  status = VL53L4CX_I2CWrite(Dev, index, &data, 1);
  return status;
}
...
VL53L4CX_Error VL53L4CX_WrWord(VL53L4CX_DEV Dev, uint16_t index, uint16_t data)
{
  ...
  status = VL53L4CX_I2CWrite(Dev, index, (uint8_t *)buffer, 2);
  return status;
}
...
VL53L4CX_Error VL53L4CX_WrDWord(VL53L4CX_DEV Dev, uint16_t index, uint32_t data)
{
  ...
  status = VL53L4CX_I2CWrite(Dev, index, (uint8_t *)buffer, 4);
  return status;
}
...
VL53L4CX_Error VL53L4CX_RdByte(VL53L4CX_DEV Dev, uint16_t index, uint8_t *data)
{
  ...
  status = VL53L4CX_I2CRead(Dev, index, data, 1);
...
VL53L4CX_Error VL53L4CX_RdWord(VL53L4CX_DEV Dev, uint16_t index, uint16_t *data)
{
  ...
  status = VL53L4CX_I2CRead(Dev, index, buffer, 2);
  if (!status) {
...
VL53L4CX_Error VL53L4CX_RdDWord(VL53L4CX_DEV Dev, uint16_t index, uint32_t *data)
{
  ...
  status = VL53L4CX_I2CRead(Dev, index, buffer, 4);
  if (!status) {
...
VL53L4CX_Error VL53L4CX_UpdateByte(VL53L4CX_DEV Dev, uint16_t index, uint8_t AndData, uint8_t OrData)
{
  ...
  status = VL53L4CX_I2CRead(Dev, index, &buffer, 1);
  if (!status) {
    buffer = (buffer & AndData) | OrData;
    status = VL53L4CX_I2CWrite(Dev, index, &buffer, (uint16_t)1);
  }
  return status;
}

VL53L4CX_Error VL53L4CX_I2CWrite(VL53L4CX_Dev_t *Dev, uint16_t RegisterAddr, uint8_t *pBuffer, uint16_t NumByteToWrite)
{
  // uint32_t i = 0;
  ...
  return Dev->I2cHandle->write(addr, regH, buffer, NumByteToWrite + 2, (void *)Dev->I2cHandle->i2c_dev);
  ...
  //   if (dev_i2c->write(addr, pBuffer + i, current_write_size, (void *)dev_i2c->i2c_dev) == 0) {
  //     return 1;
  //   } else {
  //     i += current_write_size;
  //     if (NumByteToWrite - i) {
  //       // Return an error if not all bytes were written
...
VL53L4CX_Error VL53L4CX_I2CRead(VL53L4CX_Dev_t *Dev, uint16_t RegisterAddr, uint8_t *pBuffer, uint16_t NumByteToRead)
{
  // int status = 0;
  // uint8_t buffer[2];

  uint8_t addr = (uint8_t)((Dev->I2cDevAddr >> 1) & 0x7F);
  uint16_t reg = RegisterAddr;
  ...
  // do {
    ...
    // dev_i2c->write(addr, buffer, 2, (void *)dev_i2c->i2c_dev);
...
// #endif
  ...
  // uint32_t i = 0;
  return Dev->I2cHandle->read(addr, (uint8_t *)&reg, 2, pBuffer, NumByteToRead, (void *)Dev->I2cHandle->i2c_dev);
...
VL53L4CX_Error VL53L4CX_GetTickCount(
  uint32_t *ptick_count_ms)
{
  ...
  *ptick_count_ms = (uint32_t)k_uptime_get();
...
VL53L4CX_Error VL53L4CX_WaitValueMaskEx(
  VL53L4CX_Dev_t *pdev,
  uint32_t      timeout_ms,
  uint16_t      index,
  uint8_t       value,
